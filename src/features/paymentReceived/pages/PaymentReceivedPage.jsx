            ...
            {!loading && filteredPayments.length === 0 ? (
              ...
              filteredPayments.map((p, index) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 text-sm font-medium" style={{ color: "var(--accent-hover)" }}>{p.localPaymentNumber || p.paymentNumber || "-"}</td>
                  <td className="px-5 py-3 text-sm" style={{ color: "var(--text-main)" }}>{p.paymentDate ? new Date(p.paymentDate).toLocaleString() : "-"}</td>
                  <td className="px-5 py-3 text-sm" style={{ color: "var(--text-main)" }}>{p.customerName || "-"}</td>
