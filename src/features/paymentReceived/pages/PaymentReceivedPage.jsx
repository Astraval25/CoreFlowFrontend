            ...
            {!loading && filteredPayments.length === 0 ? (
              ...
              filteredPayments.map((p, index) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 text-sm font-medium" style={{ color: "#1b5fcc" }}>{p.localPaymentNumber || p.paymentNumber || "-"}</td>
                  <td className="px-5 py-3 text-sm" style={{ color: "#202c45" }}>{p.paymentDate ? new Date(p.paymentDate).toLocaleString() : "-"}</td>
                  <td className="px-5 py-3 text-sm" style={{ color: "#202c45" }}>{p.customerName || "-"}</td>
