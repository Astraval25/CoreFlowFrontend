        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="text-2xl font-bold text-blue-700">CoreFlow</div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Smart Invoicing</h3>
              <p className="text-gray-600 leading-relaxed">Create professional invoices in seconds with automated calculations and payment tracking.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Track stock levels, manage suppliers, and automate reorder points effortlessly.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Maintain detailed customer profiles and track all interactions in one place.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Get real-time insights with comprehensive financial reports and analytics.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Bank-level security with automatic backups and 99.9% uptime guarantee.</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 leading-relaxed">Connect with your favorite tools and apps through our robust API.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl shadow-xl p-12 border border-orange-100">
              <div className="text-center">
                ...
                <h3 className="text-3xl font-bold mb-6 text-gray-900">Product Under Development</h3>
