              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@coreflow.com</p>
                    <p className="text-gray-600">support@coreflow.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Help Center & Documentation</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg">
              ...
              <p className="text-gray-600">Yes, phone support is available for Professional and Enterprise plan customers during business hours.</p>
            </div>
            <div className="bg-white p-6 rounded-lg">
              <h3 className="font-semibold mb-2">Can I schedule a demo?</h3>
              <p className="text-gray-600">Absolutely! Contact us to schedule a personalized demo of CoreFlow tailored to your business needs.</p>
            </div>
          </div>
        </div>
      </section>
